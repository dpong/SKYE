...
class Build_model():
    ...
    def build_model(self, state_size, self_feat_shape, neurons, action_size):
        ...
        flat_s1 = Flatten()(s1)
        s2 = Dense(self_feat_shape[-1]*2)(flat_s1)
        s2_norm = BatchNormalization()(s2)
        s2_norm_act = Activation('elu')(s2_norm)
        drop_s = Dropout(0.2)(s2_norm_act)
        ...
        drop4_v = Dropout(0.2)(n3_v_norm_act)
